...
CREATE TABLE [dbo].[PublicUser] (
    ...
    [UserId] INT NOT NULL,
    [active] BIT NOT NULL CONSTRAINT [PublicUser_active_df] DEFAULT 0,
    CONSTRAINT [PublicUser_pkey] PRIMARY KEY CLUSTERED ([PublicId],[UserId])
);
...
CREATE TABLE [dbo].[ContentImg] (
    ...
    [contentImgIndex] BIT CONSTRAINT [ContentImg_contentImgIndex_df] DEFAULT 0,
...
CREATE TABLE [dbo].[RewardImg] (
    ...
    [RewardImgIndex] BIT CONSTRAINT [RewardImg_RewardImgIndex_df] DEFAULT 0,
...
-- AddForeignKey
ALTER TABLE [dbo].[Public] ADD CONSTRAINT [Public_contentId_fkey] FOREIGN KEY ([contentId]) REFERENCES [dbo].[Content]([id]) ON DELETE NO ACTION ON UPDATE NO ACTION;

-- AddForeignKey
ALTER TABLE [dbo].[PublicUser] ADD CONSTRAINT [PublicUser_PublicId_fkey] FOREIGN KEY ([PublicId]) REFERENCES [dbo].[Public]([id]) ON DELETE NO ACTION ON UPDATE NO ACTION;

-- AddForeignKey
ALTER TABLE [dbo].[PublicUser] ADD CONSTRAINT [PublicUser_UserId_fkey] FOREIGN KEY ([UserId]) REFERENCES [dbo].[User]([id]) ON DELETE NO ACTION ON UPDATE NO ACTION;
