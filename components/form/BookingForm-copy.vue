  ...
  <div>
    <v-container>
      <v-row>
        ...
        <!-- <v-col cols="12" md="6" sm="6" xs="12" v-if="booking.Status">
          <v-select
            label="สถานะ"
            :items="Status"
            item-text="name"
      ...
      <v-row>
        <v-col cols="12">
          ...
          >
            ...
            <h3 class="title">กำหนดการประชุม</h3>
          </v-toolbar>
        </v-col>
        <v-col cols="12" md="6" sm="6" xs="12">
          <v-text-field
      ...
      <v-row>
        <v-col cols="12">
          ...
          >
            ...
            <h3 class="title">เลือกห้องประชุม</h3>
          </v-toolbar>
        </v-col>
        <v-col cols="12" sm="6" md="4" v-for="(item, i) in Room" :key="i">
          <v-checkbox
      ...
      <v-row>
        <v-col cols="12">
          ...
          >
            ...
            <h5 class="title">รายละเอียดการประชุม</h5>
          </v-toolbar>
        </v-col>
